...
{
    public sealed class SqlTransaction : ISqlClientTransaction, ISqlTransaction<SqliteTransaction>
    {
        ...
        public SqliteTransaction SqlClientTransaction => _sqlTransaction;
